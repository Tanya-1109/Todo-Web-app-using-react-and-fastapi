...
function App() {
  ...
  const addTodoHandler = () => {
    axios.post('http://localhost:8000/api/todo/push_data', { 'title': title, 'description': desc })
    ...
    <div className="App list-group-item  justify-content-center align-items-center mx-auto" style={{"width":"400px", "backgroundColor":"white", "marginTop":"15px"}} >
     ...
     <div className="card-body">
      ...
      <span className="card-text"> 
        ...
        <input className="mb-2 form-control desIn" onChange={event => setDesc(event.target.value)} value={desc}  placeholder='Description'/>
